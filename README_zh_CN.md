...
- [HappyClaw](https://github.com/riba2534/happyclaw) - 自托管的多用户本地 AI Agent 系统 — Powered By Claude Code.
- [Lossless Claw](https://github.com/Martian-Engineering/lossless-claw) - Lossless Claw — OpenClaw 的 LCM（无损上下文管理）插件。

</details>

<details open>
<summary><h3 style="display:inline">公司</h3></summary>
...
- [AutoClaw](https://autoglm.zhipuai.cn/autoclaw) - AutoClaw（澳龙）是一款支持 OpenClaw 一键安装的 AI 助手工具，支持 Windows 与 macOS，提供飞书集成、模型热插拔、50+技能与AutoGLM浏览器自动化能力。
